...
import { uploadDirectoryToBlob, deleteLocalDirectory, } from "../utils/azureStorage.js";
export const clonefromGh = async (ghlink) => {
    const res = await cloneRepo(ghlink);
    return res;
};
export const uploadtoServer = async (ghlink) => {
    try {
        ...
        console.log(`File uploaded to Azure Blob Storage: ${ghlink} in folder ${folderName}`);
